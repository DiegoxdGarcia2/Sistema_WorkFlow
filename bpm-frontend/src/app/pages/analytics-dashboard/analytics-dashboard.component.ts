import { Component, OnInit, signal, computed, inject, HostListener, ElementRef, ViewChild } from '@angular/core';
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-6">
          <div>
            ...
            <p class="text-xs font-bold uppercase tracking-widest text-slate-500 mt-2">
              FASE 4: Motor de Generación de Agregaciones MongoDB en Tiempo Real
            </p>
          </div>
