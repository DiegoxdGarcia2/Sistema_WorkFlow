...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-[#0e0e0f] text-[#e5e2e3] pb-32 selection:bg-indigo-500/30">
      ...
      <main class="relative z-10 pt-10 px-6 md:px-16 max-w-7xl mx-auto space-y-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-6">
          <div>
            <h1 class="text-3xl font-black tracking-tight bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
          ...
          <div class="flex items-center gap-3">
            <button (click)="toggleChatPanel()"
               ...
               💬 {{ showChatPanel() ? 'Ocultar Chat' : 'Chat Analista IA' }}
            </button>
        ...
        <div class="grid grid-cols-12 gap-8 items-start">
          ...
          <div [class]="showChatPanel() ? 'col-span-8 space-y-10' : 'col-span-12 space-y-10'">
            ...
            <section class="flex flex-col items-center gap-4">
              <div class="relative w-full max-w-2xl group transition-all duration-500">
                ...
                <div class="relative flex items-center bg-[#201f20]/60 backdrop-blur-3xl border border-white/10 rounded-2xl px-6 py-4 shadow-2xl transition-all duration-300 group-hover:border-white/20">
                  ...
                  <input 
                    ...
                    class="bg-transparent border-none focus:ring-0 text-white placeholder:text-slate-500 w-full text-base font-semibold outline-none focus:outline-none"
                  />
                  
                  <div class="flex items-center gap-3 ml-4">
                    <kbd class="hidden sm:inline-flex px-2 py-1 rounded bg-white/5 border border-white/10 text-[10px] font-mono text-slate-400 items-center gap-1 select-none">
                      <span class="text-xs">Ctrl</span>K
                    </kbd>
                    <!-- Botón de Micrófono para Búsqueda por Voz -->
                    <button 
                      (click)="toggleVoiceSearch()" 
                      [class]="isRecording() ? 'bg-red-600 hover:bg-red-500 text-white animate-pulse' : 'bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white border border-white/5'"
              ...
              <div class="flex flex-wrap justify-center gap-2 max-w-3xl mt-1">
                ...
                @for (sug of sugerencias; track sug) {
                  <button 
                    ...
                    class="px-3 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 text-[11px] font-bold text-slate-300 transition-all hover:scale-105 active:scale-95 cursor-pointer"
                  >
                    {{ sug }}
                  </button>
                }
            ...
            <section class="bg-[#131314]/60 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl transition-all hover:border-white/15 max-w-5xl mx-auto">
              <div class="flex justify-between items-center mb-4 border-b border-white/5 pb-3">
                <h3 class="text-sm font-black text-white tracking-wider flex items-center gap-2 uppercase">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="space-y-1.5">
                  ...
                  <select 
                    ...
                    class="w-full bg-[#1c1b1c] border border-white/10 rounded-xl px-3 py-2 text-xs text-slate-200 focus:border-indigo-500 outline-none"
                  >
                ...
                <div class="space-y-1.5">
                  ...
                  <div class="flex gap-1">
                    ...
                    <select 
                      ...
                      class="bg-[#1c1b1c] border border-white/10 rounded-xl px-2 py-2 text-xs text-slate-200 focus:border-indigo-500 outline-none"
                    >
              ...
              <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6 pt-4 border-t border-white/5">
            ...
            @if (!hasSearched() && !loading()) {
              <div class="p-16 rounded-[2.5rem] border border-white/5 bg-[#131314]/40 backdrop-blur-md text-center max-w-2xl mx-auto space-y-6">
                ...
                <div class="space-y-2">
                  <h3 class="text-xl font-bold text-white">Consulte en Lenguaje Natural</h3>
            ...
            @if (loading()) {
              <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                <div class="md:col-span-8 h-96 bg-white/[0.01] rounded-3xl border border-white/5 animate-pulse"></div>
                <div class="md:col-span-4 h-96 bg-white/[0.01] rounded-3xl border border-white/5 animate-pulse"></div>
                <div class="md:col-span-4 h-32 bg-white/[0.01] rounded-3xl border border-white/5 animate-pulse"></div>
                <div class="md:col-span-4 h-32 bg-white/[0.01] rounded-3xl border border-white/5 animate-pulse"></div>
                <div class="md:col-span-4 h-32 bg-white/[0.01] rounded-3xl border border-white/5 animate-pulse"></div>
              </div>
            }
            ...
            @if (hasSearched() && !loading() && !error()) {
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <!-- KPI Colección -->
                <div class="p-6 rounded-3xl border border-white/5 bg-[#131314]/40 backdrop-blur-md shadow-xl flex items-center gap-4 relative overflow-hidden group">
                  ...
                  <div>
                    ...
                    <p class="text-lg font-black text-white mt-0.5">{{ collection() }}</p>
                  </div>
                </div>
                ...
                <div class="p-6 rounded-3xl border border-white/5 bg-[#131314]/40 backdrop-blur-md shadow-xl flex items-center gap-4 relative overflow-hidden group">
                  ...
                  <div>
                    ...
                    <p class="text-lg font-black text-white mt-0.5">{{ queryResults().length }} registros</p>
                  </div>
                </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-8 bg-[#131314]/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl flex flex-col relative overflow-hidden transition-all hover:border-white/15">
                  <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div>
                      <h3 class="text-xl font-bold text-white tracking-tight">Gráfico de Resultados</h3>
                  ...
                  @if (queryResults().length > 0) {
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 p-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                      <div>
                  ...
                  <div class="flex-grow min-h-[320px] w-full relative">
                    @if (queryResults().length === 0) {
                      <div class="absolute inset-0 flex flex-col items-center justify-center text-slate-500 bg-white/[0.01] rounded-2xl border border-dashed border-white/5 p-10 text-center">
                ...
                <div class="md:col-span-4 bg-[#131314]/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl flex flex-col relative overflow-hidden transition-all hover:border-white/15">
                  <div class="flex justify-between items-center mb-6">
                    <div>
                      <h3 class="text-lg font-bold text-white tracking-tight">Pipeline Generado</h3>
                    ...
                    <button 
                      ...
                      class="p-2 rounded-xl bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white transition-all border border-white/5 relative"
                  ...
                  <div class="flex-grow overflow-hidden flex flex-col">
                    <div class="w-full flex-grow bg-[#0e0e0f] rounded-2xl border border-white/5 p-4 overflow-y-auto max-h-[380px] custom-scrollbar font-mono text-[10px] text-indigo-300 leading-relaxed">
                      <pre class="whitespace-pre-wrap select-all">{{ pipelineJson() }}</pre>
                    </div>
                  </div>
                  
                  <div class="mt-4 pt-4 border-t border-white/5 text-[9px] text-slate-500 leading-relaxed flex gap-2 items-start">
                ...
                <div class="md:col-span-12 bg-[#131314]/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl transition-all hover:border-white/15">
                  <div class="flex justify-between items-center mb-6">
                    <div>
                      <h3 class="text-xl font-bold text-white tracking-tight">Tabla de Resultados</h3>
                      <p class="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">Registros crudos obtenidos de la agregación</p>
                    </div>
                    <button 
                      (click)="descargarJSON()"
                      class="px-4 py-2 bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/5 rounded-xl font-bold text-xs transition-all active:scale-95 flex items-center gap-1.5"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                      Exportar JSON
                    </button>
                  ...
                  <!-- Table viewport -->
                  @if (queryResults().length === 0) {
                    <div class="py-12 text-center text-slate-500 font-bold uppercase tracking-widest text-xs bg-white/[0.01] border border-dashed border-white/5 rounded-2xl">
                      Sin registros que mostrar
                    </div>
                  } @else {
                    <div class="overflow-x-auto rounded-2xl border border-white/5 bg-[#0e0e0f]/50">
                      <table class="w-full border-collapse text-left">
                        <thead>
                          <tr class="bg-white/[0.02] border-b border-white/5 text-[9px] font-black uppercase tracking-wider text-slate-500">
                        ...
                        <tbody class="divide-y divide-white/5 text-xs font-semibold text-slate-300">
          ...
          @if (showChatPanel()) {
            <div class="col-span-4 bg-[#131314]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl sticky top-6 flex flex-col h-[650px] overflow-hidden animate-in slide-in-from-right duration-300">
              <div class="flex justify-between items-center pb-3 border-b border-white/5 mb-4 flex-shrink-0">
              ...
              <div class="flex-grow overflow-y-auto space-y-4 pr-2 custom-scrollbar mb-4 flex flex-col">
                @for (msg of chatMessages(); track $index) {
                  <div class="max-w-[85%] rounded-2xl p-4 text-xs leading-relaxed"
                       [class]="msg.sender === 'user' ? 'bg-indigo-600 text-white self-end rounded-tr-none' : 'bg-white/5 border border-white/5 text-slate-300 self-start rounded-tl-none'">
              ...
              <!-- Input Box -->
              <div class="relative flex items-center bg-[#1c1b1c] border border-white/10 rounded-2xl px-4 py-3 flex-shrink-0">
                 <input type="text" 
                        [(ngModel)]="chatInputText"
                        (keydown.enter)="sendChatMessage()"
                        placeholder="Escribe tu consulta..."
                        class="bg-transparent border-none focus:ring-0 text-white placeholder:text-slate-600 w-full text-xs font-semibold outline-none focus:outline-none"
                 />
...
export class NlpAnalyticsDashboardComponent implements OnInit {
    ...
    if (chartType === 'pie' || chartType === 'doughnut') {
      ...
      option = {
        ...
        tooltip: {
          ...
          formatter: '{b}: <span class="font-bold text-white">{c}</span> ({d}%)'
        },
        legend: {
          type: 'scroll',
          orient: 'vertical',
